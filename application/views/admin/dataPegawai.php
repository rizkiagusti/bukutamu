          ...
          <div class="section">
            ...
            <div id="table-datatables">
              ...
              <!-- End Alert -->
                ...
                <a href="<?php echo base_url();?>admin/tambahPegawai" class="btn blue ">Tambah<i class="mdi-av-playlist-add right"></i></a>
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url();?>admin/hapusPegawai/<?= $pegawai->nip ?>" data-target="modal1" class="modal-trigger" style="color:red" rel="tooltip" title="Hapus"><i class="mdi-action-delete"></i></a>&nbsp;
